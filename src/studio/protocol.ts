...
export interface StudioState {
  ...
  reviewError?: string;
  /**
   * Files the review covered that have changed since, such as a fixture the agent edited: the
   * review then no longer counts. script.json is compared as the page shows it.
   */
